...
export default function AchievementsSection(): JSX.Element {
  return (
    <AboutSection title="実績">
      ...
      <Text className="font-semibold">2025年03月: AtCoder Heuristic: 入緑</Text>
      <Text className="font-semibold">2025年01月: AtCoder Heuristic: 入茶</Text>
      <Text className="font-semibold">2024年08月: AtCoder Algorithm: 入茶</Text>
